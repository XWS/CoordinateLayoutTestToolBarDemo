...
import com.vic.coordinatelayouttest1.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.Collapsing.setTitle("赵桓好帅");
        binding.test.setText("\t" + "\t" + "有座小镇，大概是逃过偏远的缘故，早年逃过了那场春秋硝烟，这次竟然又逃过了这场中原战火，从头到尾，都没有听到那种演义小说中的铁骑阵阵，说书先生嘴里的那种铁甲铮铮。\n" +
                "\n" +
                ...
                "\n" +
                "    酒楼上下，几十桌客人，齐 齐轰然应诺。不少将刀剑搁在桌面 上的江湖豪客，都开始喝倒彩，许多年轻游侠儿更是使劲吹口哨。\n" +
                "\n" +
                ...
                "\n" +
                "    说书先生随即继续说道：“那位西北王爷对咱们张大侠说了，和那些装模作样的假女侠伪仙子，过招其实挺好玩的。按照那位藩王的说法，先啊，切记切记，你绝不能未战先降，觉得自己低人一等，就觉得那些仙子女侠是天经地义的高人一等！你要告诉自己，眼前那些女子再美艳动人，再孤傲清冷，她们也是要吃喝拉撒的，也是要去蹲茅坑的！吃了葱蒜鱼肉啊，也是要放臭屁的！”\n" +
                "\n" +
                "    先是满堂愕然。\n" +
                "\n" +
                "    然后便是震天响的喝彩。\n" +
                ...
                "\n" +
                "    小男孩给他娘瞪了一眼，做了个鬼脸，迅缩回脑子，继续乖乖看一楼的热闹。\n" +
                "\n" +
                "    这股天生的伶俐劲儿，肯定随他爹。\n" +
                "\n" +
                ...
                "\n" +
                "    为青衫男子环顾四周，然后抬起头，望着那个呆若木鸡的酒楼掌柜，嘴角翘起，高声喊道：“姓温的店小二！”\n" +
                "\n" +
                ...
                "\n" +
                "    皮肤微黑的小地瓜比起当初的那块小黑炭，其实已经白了许多，她快在自己爹耳边窃窃私语，疑惑问道：“爹，不是应该喊温叔叔吗？怎么要我喊温大侠啊？”\n" +
                "\n" +
                ...
                "\n" +
                "    温华举起碗，现没酒了，也没放下，“听着听着，就越想着将来有一天啊，一定要让老张在咱哥俩都在的时候，我请他坐下来，然后请你请他喝一杯酒。”\n" +
                "\n" +
